...
export function RouteDetails({ onSetOpen, isModelOpen, values }) {
  const [detailsList, setDetailsList] = useState(RouteList);
  ...
  const dataRef = collection(db, "routes");
  useEffect(() => {
